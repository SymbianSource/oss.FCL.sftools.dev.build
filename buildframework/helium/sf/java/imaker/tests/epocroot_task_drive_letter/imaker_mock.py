...
epocroot = os.path.dirname(os.path.realpath(__file__)).replace('\\', '/')
...
if sys.argv.count("help-config"):
    ...
    print epocroot + "/epoc32/rom/config/platform/product/image_conf_product.mk"
    print epocroot + "/epoc32/rom/config/platform/product/image_conf_product_ui.mk"
    print ""
    sys.exit(0)
